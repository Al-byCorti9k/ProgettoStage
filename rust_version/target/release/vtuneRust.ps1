# ============================================================================
# Script di profilazione con VTune per applicazione Rust
# ============================================================================
...
$targetApp = ".\rust_version.exe"			# Eseguibile da profilare
$pythonScript = "vtuneRust.py"				# Script Python per elaborazione aggiuntiva 
